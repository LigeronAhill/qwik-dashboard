                                    ...
                                    return (
                                        ...
                                        >
                                            <div class="flex items-center">
                                                ...
                                                />
                                                <div class="min-w-0">
                                                    <p class="truncate font-semibold text-sm md:text-base">
                                                        {invoice.name}
                                                    </p>
                                                    <p class="hidden text-gray-500 text-sm sm:block">
                                                        {invoice.email}
                                                    </p>
                                                </div>
                                            </div>
                                            <p
                                                class={`lusitana truncate font-medium text-sm md:text-base`}
                                            >
                                                {invoice.amount}
                                            </p>
                                        </div>

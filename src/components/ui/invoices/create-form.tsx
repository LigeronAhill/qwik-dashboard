...
import { fetchCustomers } from "~/data/queries";
    ...
    return (
        <Form action={createInvoiceAction}>
            <div class="rounded-md bg-gray-50 p-4 md:p-6">
                ...
                {/* Invoice Amount */}
                <div class="mb-4">
                    <label for="amount" class="mb-2 block font-medium text-sm">
                        Choose an amount
                    </label>
                ...
                {/* Invoice Status */}
                <fieldset>
                    <legend class="mb-2 block font-medium text-sm">
                    ...
                    <div class="rounded-md border border-gray-200 bg-white px-[14px] py-3">
                        <div class="flex gap-4">
                            <div class="flex items-center">
                                ...
                                <label
                                    for="pending"
                                    class="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 font-medium text-gray-600 text-xs"
                                >
                            ...
                            <div class="flex items-center">
                                ...
                                <label
                                    for="paid"
                                    class="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-green-500 px-3 py-1.5 font-medium text-white text-xs"
                                >
            ...
            <div class="mt-6 flex justify-end gap-4">
                <Link
                    ...
                    class="flex h-10 items-center rounded-lg bg-gray-100 px-4 font-medium text-gray-600 text-sm transition-colors hover:bg-gray-200"
                >
                    Cancel
                </Link>

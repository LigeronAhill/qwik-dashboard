    ...
    return (
        ...
        >
            <div class="flex p-4">
                ...
                <div class="ml-2 h-6 w-16 rounded-md bg-gray-200 font-medium text-sm" />
            </div>
...
export const InvoiceSkeleton = component$(() => {
    return (
        <div class="flex flex-row items-center justify-between border-gray-100 border-b py-4">
...
export const TableRowSkeleton = component$(() => {
    return (
        <tr class="w-full border-gray-100 border-b last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
            {/* Customer Name and Image */}
            <td class="relative overflow-hidden whitespace-nowrap py-3 pr-3 pl-6">
            ...
            {/* Actions */}
            <td class="whitespace-nowrap py-3 pr-3 pl-6">
...
export const InvoicesMobileSkeleton = component$(() => {
    return (
        <div class="mb-2 w-full rounded-md bg-white p-4">
            <div class="flex items-center justify-between border-gray-100 border-b pb-8">
                <div class="flex items-center">
            ...
            <div class="inline-block min-w-full align-middle">
                <div class="rounded-lg bg-gray-50 p-2 md:pt-0">
                    ...
                    <table class="hidden min-w-full text-gray-900 md:table">
                        <thead class="rounded-lg text-left font-normal text-sm">
                            <tr>
                                <th
                                    scope="col"
                                    class="px-4 py-5 font-medium sm:pl-6"
                                >
                                    Customer
                                </th>
                                ...
                                <th
                                    scope="col"
                                    class="relative pt-2 pr-6 pb-4 pl-3 sm:pr-6"
                                >
